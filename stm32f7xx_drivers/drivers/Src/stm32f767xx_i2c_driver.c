...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
    ...
    tempreg = 0;
    tempreg |= pI2CHandle->I2C_Config.I2C_DeviceAddress << I2C_OAR1_OA1_7BIT;
    pI2CHandle->pI2Cx->OAR1 = tempreg;
    // address mode & own address 1 enable
    pI2CHandle->pI2Cx->OAR1 &= ~(1 << I2C_OAR1_OA1MODE); // 7-bit address
    pI2CHandle->pI2Cx->OAR1 |= (1 << I2C_OAR1_OA1EN);    // address 1 enable
    //pI2CHandle->pI2Cx->CR1 |= (1 << I2C_CR1_SBC); // enable hardware byte control in slave mode
